...
package src.com.nustats.pacelogger;
...
public class SaveTrip extends Activity {
	...
	void preparePurposeButtons() {
        ...
        purpDescriptions.put(R.id.ToggleCommute,
			"<b>Commute:</b> this trip was primarily to get between home and your main workplace.");
		purpDescriptions.put(R.id.ToggleSchool,
			"<b>School:</b> this trip was primarily to go to or from school or college.");
		purpDescriptions.put(R.id.ToggleWorkRel,
			"<b>Work-Related:</b> this trip was primarily to go to or from a business related meeting, function, or work-related errand for your job.");
		purpDescriptions.put(R.id.ToggleExercise,
			"<b>Exercise:</b> this trip was primarily for exercise.");
		purpDescriptions.put(R.id.ToggleSocial,
			"<b>Social:</b> this trip was primarily for going to or from a social activity, e.g. at a friend's house, the park, a restaurant, the movies.");
		purpDescriptions.put(R.id.ToggleShopping,
			"<b>Shopping:</b> this trip was primarily to purchase or bring home goods or groceries.");
		purpDescriptions.put(R.id.ToggleErrand,
			"<b>Errand:</b> this trip was primarily to attend to personal business such as banking, a doctor  visit, going to the gym, etc.");
