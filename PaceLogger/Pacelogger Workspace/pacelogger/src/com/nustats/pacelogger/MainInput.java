...
public class MainInput extends Activity {
    ...
    private void buildAlertMessageNoGps() {
        ...
        builder.setMessage("Your phone's GPS is disabled. PaceLogger needs GPS to determine your location.\n\nGo to System Settings now to enable GPS.")
               .setCancelable(false)
    ...
    private void showWelcomeDialog() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Please enter your personal details so we can learn a bit about you.\n\nThen, try to use PaceLogger throughout your travel period. Your trip routes will be sent to NuStats.\n\nSelect Menu when you are done to save your information and continue\n\nThanks")
               .setCancelable(false).setTitle("Welcome to PaceLogger!")
	...
	void populateList(ListView lv) {
		...
		try {
			...
			switch (numtrips) {
			case 0:
				counter.setText("Press Menu for help or settings\n\nNo saved trips.");
				break;
			case 1:
				counter.setText("Press Menu for help or settings\n\n1 saved trip:");
				break;
			default:
				counter.setText("Press Menu for help or settings\n\n" + numtrips + " saved trips:");
			}
			// allTrips.close();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_HELP:
        	Intent myIntent = new Intent(Intent.ACTION_VIEW,
        			Uri.parse("http://pacelogger.nustats.com/android-help.asp"));
